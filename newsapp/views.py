...
def homePageView(request):
    ...
    local_news = News.published.filter(category__name='Mahalliy').order_by("-published_time")[1:13]
...
class HomePageView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['xorij_xabarlari'] = News.published.all().filter(category__name="Xorij").order_by("-published_time")[:5]
        context['sport_xabarlari'] = News.published.all().filter(category__name="Sport").order_by("-published_time")[:5]
        context['texnologiya_xabarlari'] = News.published.all().filter(category__name="Texnologiya").order_by("-published_time")[:5]
